...
<?php echo text_output($header, 'h1', 'page-head');?>
	<?php if (isset($character)): ?>
		<div class="span4 bioinfo">
			<?php if (isset($character['image']['src'])): ?>
				<ul class="gallery">
					<li><a href="<?php echo $character['image']['src'];?>" class="image" rel="prettyPhoto[gallery]">
						<?php echo str_replace('<img' , '<img class="char_bio_image" style="user-drag: none; -moz-user-select: none;-webkit-user-drag: none;"' , img($character['image']));?></a></li>
		...
		<div class="span12" style="padding-top:15px;clear:both;">
			<?php if (isset($tabs)): ?>
				<div id="tabs">
					<ul>
